...
| 9 | Решения с доказательствами и тест-кейсами | первичные документы API/стандартов, 76 автоматизированных тестов и scheduled live smoke | `docs/RESEARCH.md`, `docs/INGESTION.md`, `tests/`, `.github/workflows/live-sources.yml` | Реализовано для MVP |
