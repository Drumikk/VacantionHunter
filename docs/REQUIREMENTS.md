...
| 9 | Решения с доказательствами и тест-кейсами | первичные документы API/стандартов, 35 автоматизированных тестов | `docs/RESEARCH.md`, `docs/INGESTION.md`, `tests/` | Реализовано для MVP |
