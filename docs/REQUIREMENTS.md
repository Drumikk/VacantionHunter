...
| 9 | Решения с доказательствами и тест-кейсами | первичные документы API/стандартов, 82 автоматизированных теста и scheduled live smoke | `docs/RESEARCH.md`, `docs/INGESTION.md`, `tests/`, `.github/workflows/live-sources.yml` | Реализовано для MVP |
